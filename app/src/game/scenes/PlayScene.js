...
export default class PlayScene extends Phaser.Scene {
  ...
  preload ()
  {
      this.load.image('bg', 'assets/temp floors/workbench.png');
      this.load.image('demosWindow', 'assets/temp floors/demos-window.png');
      this.load.image('eyesIcon', 'assets/temp floors/eyes-icon.png');
      this.load.image('starsIcon', 'assets/temp floors/stars-icon.png');
      this.load.image('jugglerIcon', 'assets/temp floors/Floor_1.png');
      this.load.image('twistIcon', 'assets/temp floors/twist-icon.png');
      this.load.image('invadersIcon', 'assets/temp floors/invaders-icon.png');
      this.load.image('clockIcon', 'assets/temp floors/clock-icon.png');

      this.load.image('starsWindow', 'assets/temp floors/stars-window.png');
      this.load.image('sineWindow', 'assets/temp floors/sinewave-window.png');
      this.load.image('eyesWindow', 'assets/temp floors/eyes-window.png');
      this.load.image('jugglerWindow', 'assets/temp floors/Floor_1.png.png');
      this.load.image('invadersWindow', 'assets/temp floors/invaders-window.png');
      this.load.image('clockWindow', 'assets/temp floors/clock-window.png');

      this.load.spritesheet('juggler', 'assets/temp floors/juggler.png', { frameWidth: 128, frameHeight: 184 });
      this.load.image('star', 'assets/temp floors/star2.png');
      this.load.image('eye', 'assets/temp floors/eye.png');
