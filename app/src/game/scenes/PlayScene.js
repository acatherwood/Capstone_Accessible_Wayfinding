...
export default class PlayScene extends Scene {
  ...
  create = function(){
    ...
    var elevatorIcon = this.add.image(518,318, 'elevator').setScale(1);
    elevatorIcon.setDepth(2);
    
    var elevatorIconTwo = this.add.image(1512,318,'elevator').setScale(1);
    ...
    var restroom2=this.add.image(1120,430,'restroom').setScale(1);
    restroom2.setDepth(2);

    var restroom3=this.add.image(1575,280,'restroom').setScale(1);
    restroom3.setDepth(2);

    var restroom4=this.add.image(342,1500,'restroom').setScale(1);
    restroom4.setDepth(2);
    
    var restroom5=this.add.image(1552,1456,'restroom').setScale(1);
    ...
    var floor0icon = this.add.sprite(15, 210, 'floor2icon', 0).setOrigin(0).setInteractive().setScale(.05).setScrollFactor(0);
    ...
    var floorGicon = this.add.sprite(15, 210, 'moveBTN', 0).setOrigin(0).setInteractive().setScale(0.05).setScrollFactor(0);
